...
/* ----------------------------------------------------------- */
/* BEGIN new code for summary collection filter gallery        */
/*    03/21/2022 - initial                                     */
/* ----------------------------------------------------------- */
...
Dependent functions:
   intersection - finds item intersecting two groups
   adjustGalleryItemHeight - initial and on window resize, adjust images
   cleanUpArray - normalize a spreadsheet array into a normal array [1,2,3]
   filterGalleryShowvals - Sets up the gallery filter checkboxes/radio buttons
   makeFilterBoxes - build the actual checkboxes
   createFilteredGallery - MAIN entry point for building the filtered gallery
   formatGalleryItems - reads json data and builds gallery items in flexbox 
*/
...
/* ------------------------------------------------------- */
/* filterGalleryShowvals - Sets up the filter checkboxes   */
/*     and radio buttons                                   */
/* ------------------------------------------------------- */
...
/* ------------------------------------------------------- */
/* makeFilterBoxes - build the checkbox/radio button       */
/*     html code                                           */
/* ------------------------------------------------------- */
...
/* ------------------------------------------------------- */
/* createFilteredGallery - get spreadsheet data and        */
/*     set things up, call function to build filter boxdes */
/* ------------------------------------------------------- */
...
/* ------------------------------------------------------- */
/* formatGalleryItems - reads json data and build          */
/*     gallery items in flexboxs                           */
/* ------------------------------------------------------- */
